...
public class Robot_OmniDrive
{
    ...
    public void initDrive(LinearOpMode opMode) {
        ...
        leftFront        = myOpMode.hardwareMap.get(DcMotor.class, "motor0");
        rightFront       = myOpMode.hardwareMap.get(DcMotor.class, "motor1");
        leftRear         = myOpMode.hardwareMap.get(DcMotor.class, "motor2");
        rightRear        = myOpMode.hardwareMap.get(DcMotor.class, "motor3");


        leftFront.setDirection(DcMotor.Direction.REVERSE); // Positive input rotates counter clockwise
        rightFront.setDirection(DcMotor.Direction.FORWARD);// Positive input rotates counter clockwise
        leftRear.setDirection(DcMotor.Direction.REVERSE); // Positive input rotates counter clockwise
    ...
    public void moveRobot() {
        ...
        double leftFrontPower  = driveAxial + driveYaw + driveLateral;
        double rightFrontPower = driveAxial - driveYaw - driveLateral;
        double leftRearPower   = driveAxial + driveYaw - driveLateral;
        double rightRearPower  = driveAxial - driveYaw + driveLateral;
        ...
        myOpMode.telemetry.addData("Wheels", "LF[%+5.2f], RF[%+5.2f], LR[%+5.2f], RR[%+5.2f]", leftFrontPower, rightFrontPower, leftRearPower, rightRearPower);
    }
