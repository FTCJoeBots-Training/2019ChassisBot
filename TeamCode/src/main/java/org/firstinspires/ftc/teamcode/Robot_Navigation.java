...
public class Robot_Navigation
{
    ...
    public void initVuforia(LinearOpMode opMode, Robot_OmniDrive robot) {
        ...
        myOpMode = opMode;
        myRobot = robot;
        WebcamName joeBotWebcam = myOpMode.hardwareMap.get(WebcamName.class, "Webcam");
